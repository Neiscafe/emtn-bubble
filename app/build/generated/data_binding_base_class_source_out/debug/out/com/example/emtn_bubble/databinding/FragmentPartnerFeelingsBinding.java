...
public final class FragmentPartnerFeelingsBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentPartnerFeelingsBinding(@NonNull NestedScrollView rootView,
  ...
  @NonNull
  public static FragmentPartnerFeelingsBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentPartnerFeelingsBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_partner_feelings, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentPartnerFeelingsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentPartnerFeelingsBinding((NestedScrollView) rootView, buttonSecond,
          textviewSecond);
    }
